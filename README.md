[![Build Status](https://travis-ci.org/micromata/kitt.svg?branch=master)](https://travis-ci.org/micromata/kitt)
[![Dependency Status](https://david-dm.org/micromata/kitt.svg)](https://david-dm.org/micromata/kitt)
[![devDependency Status](https://david-dm.org/micromata/kitt/dev-status.svg)](https://david-dm.org/micromata/kitt#info=devDependencies)
[![Join the chat at https://gitter.im/micromata/kitt](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/micromata/kitt?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Twitter](https://img.shields.io/badge/Twitter-%40kitt.io%20-blue.svg?style=flat)](https://twitter.com/kitt.io)
[![Unicorn](https://img.shields.io/badge/unicorn-approved-ff69b4.svg?style=flat)](https://www.youtube.com/watch?v=qRC4Vk6kisY)

# KITT – a build workflow for your web development needs

![Logo](src/assets/img/kitt-logo.png)

The aim of this project is to help you to build your things. From Bootstrap themes over static websites to single page applications. KITT provides:
...
### via Yeoman
	...
	$ npm install -g yo
	$ npm install -g generator-kitt
	$ yo kitt
	$ gulp --tasks

See: <https://github.com/micromata/generator-kitt>

### via Git

	$ git clone https://github.com/micromata/kitt.git
	$ cd kitt
	$ npm install
	$ gulp --tasks
...
Navigate to the root of your checkout:
	...
	cd path/to/your/checkout/of/kitt
...
````
Tasks for ~/Documents/Projects/kitt/gulpfile.babel.js
...
### This is optional
Using Handlebars instead of plain HTML is fully optional and will probably suit your needs if you use KITT for creating a static site. If you are developing a single page application instead you might turn of handlebars compiling and place `.html` files in the `/src` directory.
...
Frontmatters are basically a key/value storage you can access within your layouts, pages and partials via Handlebars.  This empowers you to do things like [handling active states](https://github.com/micromata/kitt/blob/master/src/handlebars/partials/navbar.hbs#L16-L22) of your navigation and much more.
...
See the last [commits](https://github.com/micromata/kitt/commits) of KITT for some real life commit messages.
